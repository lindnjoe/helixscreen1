...
class HomeWidget {
  public:
    ...
    /// Stable identifier matching HomeWidgetDef::id
    virtual const char* id() const = 0;
};

/// Safe recovery of HomeWidget pointer from event callback.
/// Returns nullptr if widget was detached or obj has no user_data.
template <typename T> T* home_widget_from_event(lv_event_t* e) {
