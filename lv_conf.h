...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (2 * 1024 * 1024U)          /*[bytes]*/  /* 2MB for images */
...
/* Enable name-based widget lookup (lv_obj_find_by_name, lv_obj_get_child_by_name) */
#define LV_USE_OBJ_NAME         1

/* Add `id` field to `lv_obj_t` - DISABLED, using names instead */
 ...
 *DISABLED: Using Noto Sans instead (smaller binary, better Unicode support)*/
...
#define LV_SYMBOL_OK        "\xF3\xB0\xB8\x9E"  /* MDI check-bold (F0E1E) */
...
/*Use SDL to open window on PC and handle mouse and keyboard*/
    ...
    #define LV_SDL_DIRECT_EXIT      0    /*0: Return to main loop for graceful shutdown (prevents deadlock on exit)*/
