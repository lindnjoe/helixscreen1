...
package_platform() {
    ...
    # These are generated by 'make gen-images' and live in build/assets/
    if [ -d "${build_dir}/assets/images/prerendered" ]; then
        mkdir -p "$pkg_dir/assets/images/prerendered"
        cp "${build_dir}/assets/images/prerendered/"*.bin "$pkg_dir/assets/images/prerendered/" 2>/dev/null || true
    ...
    # These are generated by 'make gen-printer-images'
    if [ -d "${build_dir}/assets/images/printers/prerendered" ]; then
        mkdir -p "$pkg_dir/assets/images/printers/prerendered"
        cp "${build_dir}/assets/images/printers/prerendered/"*.bin "$pkg_dir/assets/images/printers/prerendered/" 2>/dev/null || true
