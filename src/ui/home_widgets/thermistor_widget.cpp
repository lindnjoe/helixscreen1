...
// File-local helper: get the shared HomeWidgetConfig instance
static helix::HomeWidgetConfig& get_widget_config_ref() {
...
void ThermistorWidget::thermistor_clicked_cb(lv_event_t* e) {
    ...
    auto* widget = home_widget_from_event<ThermistorWidget>(e);
    if (widget) {
